...
# for i in range(0, len(ps)):
#     if ps[i] == 1:
#         ax.scatter(peA[i], peB[i], xA[i], c='k')
#         # This takes advantage of symmetry
#         ax.scatter(peB[i], peA[i], 1.0 - xA[i], c='k')
#     else:
#         ax.scatter(peA[i], peB[i], xA[i], facecolor='none', edgecolor='k')
#         # Symmetry!
#         ax.scatter(peB[i], peA[i], 1.0 - xA[i], facecolor='none', edgecolor='k')
#
# ax.set_xlabel('Activity A')
# ax.set_ylabel('Activity B')
# ax.set_zlabel('Fraction A')
#
# plt.show()
