...
do
    ...
    read pe_b
    echo "eps_start is ${eps_start}, input new value or same value."
    read eps_start
    echo "eps_spacer is ${eps_spacer}, input new value or same value."
    read eps_spacer
    echo "eps_max is ${eps_max}, input new value or same value."
    read eps_max
...
do
    ...
    do
        ...
        do
            ...
            $sedtype -i 's/\${eps}/'"${eps_count}"'/g' $infile                      # write epsilon to infile
            ...
            eps_count=$(( $eps_count + $eps_spacer ))
