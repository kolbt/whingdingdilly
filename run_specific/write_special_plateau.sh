...
#    template='/nas/longleaf/home/kolbt/whingdingdilly/run_specific/vary_v_and_eps.py'
    template='/nas/longleaf/home/kolbt/whingdingdilly/run_specific/plateau_epsilon_hs.py'
    sedtype='sed'
    submit='sbatch'
else
...
#    template='/Users/kolbt/Desktop/compiled/whingdingdilly/run_specific/vary_v_and_eps.py'
    template='/Users/kolbt/Desktop/compiled/whingdingdilly/run_specific/plateau_epsilon_hs.py'
    sedtype='gsed'
    submit='sh'
fi
