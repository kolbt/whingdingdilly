...
if [ $answer == "y" ]; then
    ...
    template='/nas/longleaf/home/kolbt/whingdingdilly/run_specific/convergence_study.py'
    sedtype='sed'
    submit='sbatch'
else
    ...
    template='/Users/kolbt/Desktop/compiled/whingdingdilly/run_specific/convergence_study.py'
    sedtype='gsed'
    submit='sh'
fi
