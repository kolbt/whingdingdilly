...
if [ $answer == "y" ]; then
    ...
    script_path='/nas/longleaf/home/kolbt/whingdingdilly/post_proc/test_post_proc'
    sedtype='sed'
    submit='sbatch'
else
    ...
    script_path='/Users/kolbt/Desktop/compiled/whingdingdilly/post_proc/test_post_proc'
    sedtype='gsed'
    submit='sh'
fi
...
do
    ...
    $submit $script_path/test_analyze.sh $pa $pb $xa $hoomd_path $gsd_path $script_path
