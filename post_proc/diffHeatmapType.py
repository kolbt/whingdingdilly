...
# Only outputs images for the longer timescale data
for j in range(dump_short, end):
    ...
    im = plt.imshow(binMinus.T, cmap='bwr', origin='lower', vmin=-25, vmax=25) # bottom right
    ax = plt.gca()
    ax.set_aspect('equal')
