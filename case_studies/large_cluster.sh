...
# This script instantiates a cluster that contains 99% of all particles
...
if [ $answer == "y" ]; then
    ...
    tempTwo='/nas/longleaf/home/kolbt/whingdingdilly/case_studies/large_cluster.py'
    sedtype='sed'
    submit='sbatch'
else
    ...
    tempTwo='/Users/kolbt/Desktop/compiled/whingdingdilly/case_studies/large_cluster.py'
    sedtype='gsed'
    submit='sh'
fi
