...
#sys.path.append('/nas/longleaf/home/kolbt/programs/fake/hoomd-blue/build')
...
# Start 99% of the system in a cluster
NLiq = partNum - int(partNum/100.)
NGas = partNum - NLiq
...
hbox = lbox / 2.
if rLiq >= hbox:
    sys.exit("Cluster is larger than system box size!")
tooClose = 0.9
